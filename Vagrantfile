...
Vagrant.configure("2") do |config|
    ...
    machines.each do |hostname, info|
        config.vm.define hostname do |lbconf|
            lbconf.vm.synced_folder "saltstack/salt", "/srv/salt/states"
            lbconf.vm.synced_folder "saltstack/pillar", "/srv/salt/pillar"
            ...
            lbconf.vm.provision "salt" do |salt|
                ...
                salt.minion_config = "saltstack/etc/minion.conf"
